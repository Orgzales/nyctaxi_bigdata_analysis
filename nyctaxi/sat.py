...
df = pd.read_csv('/data/airline-passenger-satifaction/train.csv')
print(df)
print(df.columns)
...
#	'Gate Location', 'Food and drink', 'Online boarding', 'Seat confort',
...
#	'Departure Delay in Minutes', 'Arrival Delay in Minutes', 'Cleanliness', 'Gender',
#	'Customer Type', 'Age', 'Type of Travel', 'Gate location', 'On-board service', 
#	'Leg room service', Baggage handling', 'Checkin Service', 'Inflight service', 
#	'satisfaction']]

df_sat = df[['Inflight wifi service', 'Departure/Arrival time convenient', 'Ease of Online booking', 'Class', 'Flight Distance', 'Food and drink', 'Online boarding', 'Seat comfort', 'Departure Delay in Minutes', 'Arrival Delay in Minutes', 'Cleanliness', 'Gender', 'Customer Type', 'Age', 'Type of Travel', 'Gate location', 'On-board service', 'Leg room service', 'Baggage handling', 'Checkin service', 'Inflight service', 'satisfaction']]
